...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Page homePage = new PageBuilder().setUrl("anotherwebsite.com").addNonRedirectingeAction(new ActionBuilder().setActionId("Menu clicked").build()).build();
        Website anotherWebite = new WebsiteBuilder().setHomePage(homePage).setName("AnotherWebsite").addPage(homePage).build();

        //Adding a non redirecting action to a page
        Page homePage2 = new PageBuilder().setUrl("whoopwhoop.con").addRedirectingAction(new ActionBuilder().build(),new PageBuilder().build()).build();
        ...
        Page aPage = new PageBuilder().setNumberOfAutogeneratedActions(1).build();
