...
public class ClickStreamGeneratorBuilder {
    ...
    private int numberOfAutoGeneratedUsers = 1; //TODO: change number of default users
    private List<User> users = new ArrayList<>();
    private int numberOfLinesToGenerate = 10;
    ...
    public ClickStreamGeneratorBuilder addUsers(List<User> users) {
        ...
        // NOT neccecary!!! done in build() and generateUsers()
